...
def fit(model: torch.nn.Module, dataloader: torch.utils.data.DataLoader, loss_func=torch.nn.MSELoss(), optimiser=torch.optim.Adam, epochs=100, lr=0.01, device="cpu"):
    model.to(device)
